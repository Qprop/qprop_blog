...
What is __Regular Expression__ *a.k.a* __RegEx__ , an attempt to define this is at times makes the tool use under explained or overly complicated. Though let me try __RegEx__ in simple terms is a way of handling and manipulating characters in ways different ways while simplifying the effort of the process.
